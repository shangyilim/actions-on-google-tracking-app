...
//
exports.addPlan = functions.https.onRequest((request, response) => {
...
function trackTask(app) {
    ...
    const endDate = new Date(app.getArgument('endDate'));
    return admin.firestore().collection('tasks')
        ...
        return app.ask(app.buildRichResponse()
            .addSimpleResponse(`All set! I am now keeping track of the task ${task}. 
